...
import com.humaine.portal.api.model.Privilege;
import com.humaine.portal.api.model.UserAdmin;
import com.humaine.portal.api.model.UserPrincipal;
...
public class UserServiceImpl implements UserDetailsService, UserService {
	...
	public UserDetails loadUserByUsername(String userName) {
		...
		UserAdmin user = userRepository.findByUserNameAndStatus(userName, UserStatus.ACTIVE.getStatus());
		if (user == null) {
