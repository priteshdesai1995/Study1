...
@Setter
@ToString
@Table(name = "ai_user_group_deleted")

public class AIUserGroupDeleted {
	...
	@Column(name = "ai_user_group_id", nullable = false)
	Long aiUserGroupId;
	...
	public AIUserGroupDeleted(AIUserGroup group) {
		this.aiUserGroupId = group.getId();
		this.userGroupId = group.getUserGroupId();
