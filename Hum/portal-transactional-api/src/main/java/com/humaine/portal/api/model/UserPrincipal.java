...
public class UserPrincipal implements UserDetails {
	...
	public UserPrincipal(UserAdmin user, boolean accountNonLocked, boolean accountNonExpired,
			boolean credentialsNonExpired, boolean enabled, Long userId,
...
//		this.authorities = translate(user.getUserRole());
		...
		this.userId = userId;
		this.firstName = user.getUser_profile().getFirstName();
		this.lastName = user.getUser_profile().getLastName();
		this.email = user.getUser_profile().getEmail();
	}
