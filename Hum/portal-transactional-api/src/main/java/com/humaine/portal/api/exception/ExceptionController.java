...
import com.humaine.portal.api.util.ErrorField;
...
public class ExceptionController extends ResponseEntityExceptionHandler {
	...
	public TransactionInfo handleJwtException(HttpServletRequest request, CognitoException exception) {
		TransactionInfo transactionInfo = new TransactionInfo(ErrorStatus.FAIL);
		log.error("{} {}", ErrorMessageBuilder.retriveCode(exception.getMessage()),
				ErrorMessageBuilder.retriveMessage(exception.getMessage()));
		transactionInfo.addErrorList(new ErrorField(exception.getErrorCode(),exception.getErrorMessage()));
