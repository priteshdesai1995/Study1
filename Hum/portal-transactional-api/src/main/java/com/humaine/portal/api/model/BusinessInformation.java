...
public class BusinessInformation {
	...
	public void setRegistrationInfo(RegistrationRequest request) {
		...
		this.setEShopHosting(request.getEShopHostedOn());
		this.setHeadquarterLocation(request.getHeadquarterLocation());
		this.setConsumersFrom(request.getCosumersFrom());
		this.setNoOfEmployees(request.getNoOfEmployees());
		this.setHighestProductPrice(request.getHighProductPrice());
		this.setNoOfProducts(request.getNoOfProducts());
		this.setCurrentAnalyticsSolution(request.getCurAnalyticsTool());
		...
		this.setUrl(request.getBusinessURL());
	}
}
